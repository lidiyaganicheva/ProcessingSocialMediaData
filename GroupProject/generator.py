...
KAFKA_GENERATOR_TOPIC = config.KAFKA_GENERATOR_TOPIC
...
def send_comments(producer_id):
    ...
    for comment in comment_gen:
        try:
            ...
            producer.send(KAFKA_GENERATOR_TOPIC, key=key, value=message)
...
if __name__ == "__main__":
    create_topic_if_not_exists(KAFKA_GENERATOR_TOPIC, NUM_PARTITIONS, REPLICATION_FACTOR)
